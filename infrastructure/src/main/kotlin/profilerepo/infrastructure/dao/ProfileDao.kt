package profilerepo.infrastructure.dao
...
@Service
class ProfileDao(val db: JdbcTemplate) : IProfileDao {

    override fun findProfile(innHash: InnHash) : Profile? {
    ...
    override fun getAllProfiles(): Collection<ProfileDto> = db.query(SELECT_ALL_PROFILES_SQL) { response, _ ->
        ProfileDto(
    ...
    override fun getById(id: ProfileId): Profile {
